package com.mohamedragab.cashpos.modules.invoicebuyback.views;
...
import com.mohamedragab.cashpos.modules.invoicebuyback.wedgits.invoicebuyAdapter;
...
public class invoicebuyView extends AppCompatActivity {
    ListView invoice_lv;
    TextView search;
    List<invoice> invoiceList;
    DataBaseHelper db;
    invoicebuyAdapter invoiceAdapter;
    private Calendar mcalendar;
    private int day, month, year;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_invoicebuy);
        ...
        invoiceAdapter = new invoicebuyAdapter(invoicebuyView.this, invoiceList);
    ...
    public void DateDialog() {
        ...
        DatePickerDialog.OnDateSetListener listener = (view, year, monthOfYear, dayOfMonth) -> {
            ...
            MediaPlayer mp = MediaPlayer.create(invoicebuyView.this, R.raw.finalsound);
            mp.start();
