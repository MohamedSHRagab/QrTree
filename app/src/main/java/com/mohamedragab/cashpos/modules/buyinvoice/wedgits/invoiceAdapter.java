package com.mohamedragab.cashpos.modules.buyinvoice.wedgits;
...
import com.mohamedragab.cashpos.modules.buyinvoicedetails.views.buyinvoicedetails;
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        try {
            ...
            linearLayout.setOnClickListener(view -> {
                ...
                Intent i = new Intent(con, buyinvoicedetails.class);
